...
import { useAddRate } from "@/hooks/rate";
...
const AddRate = ({
  ...
  const { mutate: addRate, isPending } = useAddRate();
        ...
        >
          <div className="p-6">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-bold ">Thêm mới đánh giá</h2>
              <button
            ...
            >
              <div className="flex flex-col gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <Controller
                    ...
                    control={control}
                    render={({ field }) => (
                      <Input {...field} id="MaDG" className="rounded" />
                    )}
                  />
                  {errors.MaDG && (
                          ...
                          <SelectGroup>
                            {users &&
                              ...
                              users.map((user: IUser) => {
                                return (
                                  <SelectItem value={user.MaTK} key={user.MaTK}>
                                    {user.MaTK}
                                  </SelectItem>
                                );
                              })}
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <Label htmlFor="BinhLuan" className=" font-normal opacity-70">
                    Bình luận
                  </Label>
